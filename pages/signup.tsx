...
const SignUpPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push({
                pathname: '/login',
                query: { message: 'Account created! An administrator will review your registration. You will be notified via email upon approval.' }
            });
                ...
                <div className="w-full max-w-md p-8 space-y-6 bg-slate-800 rounded-2xl shadow-2xl border border-slate-700">
                    ...
                    <p className="text-center text-sm text-slate-400">
                        ...
                        <Link href="/login" legacyBehavior>
                           <a className="font-medium text-emerald-400 hover:text-emerald-300">
                            Sign In
                           </a>
                        </Link>
                    </p>
